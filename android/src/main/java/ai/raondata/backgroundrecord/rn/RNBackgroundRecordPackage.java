...
public class RNBackgroundRecordPackage implements ReactPackage {
    /**
     * Provides the {@link ai.raondata.backgroundrecord.rn.RNBackgroundRecordModule} to the {@link com.facebook.react.ReactApplication}.
     *
    ...
    public List<NativeModule> createNativeModules(ReactApplicationContext reactContext) {
      return Collections.singletonList(new RNBackgroundRecordModule(reactContext));
    }
